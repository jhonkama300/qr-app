      ...
      <AdminRoute>
        <div className="flex-1 space-y-3 md:space-y-6 p-2 md:p-6">
          <div className="flex items-center gap-3 md:gap-4">
            ...
            <div>
              <h1 className="text-base md:text-2xl font-bold text-uparsistem-800 dark:text-uparsistem-200 leading-tight">Base de Datos</h1>
              <p className="text-[10px] md:text-sm text-uparsistem-700 dark:text-uparsistem-300 leading-tight mt-0.5">Administra y gestiona los registros del sistema</p>
            </div>
          </div>
          <DatabaseManagement />
        </div>
