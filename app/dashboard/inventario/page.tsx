  ...
  return (
    <div className="flex-1 space-y-3 md:space-y-6 p-2 md:p-6">
      <div className="flex items-center gap-3 md:gap-4">
        ...
        <div>
          <h1 className="text-base md:text-2xl font-bold text-gray-900 leading-tight">Gestión de Inventario</h1>
          <p className="text-[10px] md:text-sm text-gray-500 leading-tight mt-0.5">Administra el inventario global de comidas del evento</p>
        </div>
      </div>
